...
namespace POS_and_Inventory_Management_System.CASHIER
{
    public partial class frm_PrintReceipt : Form
    {
        ...
        string companyName = "TK UPTREND Electricals enterprise";
        ...
        public void LoadReceipt()
        {
            ...
            try
            {
                ...
                cn.Open();
                da.SelectCommand = new SqlCommand("select SalesId, TransactionNo, TransactionDate,bmonth, bmothyear,ProductCode, ProductName, category, price, tax,totalProductPrice,qty,totalPriceqty,subTotal,totaltax,totalprice,discount,grandTotal,payMode, receivedamount, balance from tblSales where TransactionNo like '" + flist.lbl_TransactionNo.Text + "'", cn);
